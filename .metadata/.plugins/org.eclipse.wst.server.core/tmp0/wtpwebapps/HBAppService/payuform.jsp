...
%>
<% 	
	String merchant_key="QHC8Wx";
	String salt="QTiOlCOR";
	String action1 ="";
	...
	String txnid ="BA154928074936BH78";
	String udf2 ="";
...
<input type="hidden" name="key" value="<%= merchant_key %>" />
      ...
      <table>
        ...
        <tr>
          ...
          <td>Cancel URI: </td>
          <td><input name="curl" value="https://testservice.hungrybells.in/HBAppService/payumoneyrequest.do" /></td>
        </tr>
        <tr>
          <td>Address1: </td>
        ...
        <tr><a href="http://localhost:8090/HBAppService/getResponseFromPayu.do">initiated</a></tr>
      </table>
    </form>
